    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex align-items-center mb-2">
          <Fa icon="{faServer}" size="lg" style="width: 3rem" />
          {info.os}
        </div>
        <div class="d-flex align-items-center mb-2">
          <Fa icon="{faMicrochip}" size="lg" style="width: 3rem" />
          {info.cpus} CPUs
        </div>
        <div class="d-flex align-items-center mb-2">
          <Fa icon="{faMemory}" size="lg" style="width: 3rem" />
          {bytes2human(info.mem)}
          Memory
        </div>
        <div class="d-flex align-items-center mb-2">
        ...
        <div class="mt-3">
          <a href="https://github.com/knrdl/caasa" target="_blank" rel="noopener noreferrer" class="text-decoration-none">
